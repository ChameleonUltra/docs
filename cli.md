...
7. Clone the Repository by typing `git clone https://github.com/ChameleonUltra/ChameleonUltra.git`
...
6. Choose a suitable location and open a terminal. Clone the repository with `git clone https://github.com/ChameleonUltra/ChameleonUltra.git`
...
git clone https://github.com/ChameleonUltra/ChameleonUltra.git
(
